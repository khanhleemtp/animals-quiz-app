...
function Question({ score, setScore, id, updateScore }) {
    ...
    return (   
        ...
        >
            ...
            >
                <div id="img-question" className="question-img h-24 w-5/12 ml-6 col-start-2 col-end-4 sm:w-6/12 sm:mb-16 sm:ml-12 md:mx-12 md:mt-16 md:w-8/12 lg:w-12/12 lg:w-full overflow-visible lg:mt-24 lg:col-span-1 xl:ml-48">
                            {
