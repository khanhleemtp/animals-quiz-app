...
function Home({ setShowModal, users, openNav, setOpenNav }) {
    ...
    >   
        ...
        <div className="grid grid-cols-3 gap-2 p-6 bg-primary-100 text-primary-700 lg:px-16 lg:p-10 h-screen overflow-hidden">
            ...
            {
                openNav ?
                <motion.nav className={`flex flex-col justify-center items-center col-span-3`}
                    variants={navVariant}
                >
            ...
            <motion.nav className="hidden sm:flex flex-row justify-center items-center col-span-3 lg:text-xl"
                    variants={navVariant}
                >
                <div className="rounded-full bg-primary-200 hidden sm:flex justify-center items-center w-full h-10 text-center uppercase">
                    <Link to="#">Home</Link>
                </div>
                <div className="rounded-full bg-primary-200 hidden sm:flex justify-center items-center w-full h-10 text-center uppercase m-2">
                    <Link to="#">About</Link>
                </div>
                <div className="rounded-full bg-primary-200 hidden sm:flex justify-center items-center w-full h-10 text-center uppercase">
                    <Link to="#">Contact</Link>
            ...
            <div className="roket flex flex-col text-2xl font-light col-span-3 lg:col-span-1 lg:h-64 lg:ma">
                <motion.div className="welcome flex justify-start items-center tracking-wider text-primary-400"
                    variants={navVariant}
                >
                ...
                <div className="rank m-2 top-0 grid grid-cols-2 text-center cursor-pointer lg:mr-24 lg:text-4xl">
            ...
            <div className="hashtag text-center col-span-3 lg:col-span-1 lg:pt-32 lg:text-6xl">
            ...
            <div className="calender col-span-1 hidden lg:flex lg:justify-center lg:items-center">
            ...
            <div className="rounded-full mt-0 bg-primary-200 flex justify-center items-center col-span-3">
                <motion.p className="bg-primary-500 px-12 rounded-full px-auto py-2 text-3xl my-5 outline-none cursor-pointer"
