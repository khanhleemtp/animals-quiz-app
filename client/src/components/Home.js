...
function Home({ setShowModal, users, openNav, setOpenNav }) {
    ...
    >   
        ...
        <div className="grid grid-cols-3 gap-2 p-4 bg-primary-100 text-primary-700 lg:p-10 min-h-screen lg:max-h-screen top-0">
            ...
            <div className="roket flex flex-col text-2xl font-light col-span-3 lg:col-span-1 lg:h-48 lg:-mt-6 ">
            ...
            <div className="calender col-span-1 hidden lg:flex lg:-mr-8 lg:-mt-20 justify-center items-center">
            ...
            <div className="rounded-full md:h-32 flex justify-center items-center col-span-3 md:bg-primary-200 md:-mt-16">
                <motion.p className="bg-primary-500 px-6 rounded-full py-1 text-2xl sm:text-3xl outline-none cursor-pointer"
